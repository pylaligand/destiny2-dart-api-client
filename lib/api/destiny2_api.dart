...
class Destiny2Api {
  ...
  Future<InlineResponse20019> destiny2AwaProvideAuthorizationResult() async {
    Object postBody = null;
  ...
  Future<InlineResponse20019> destiny2EquipItem() async {
    Object postBody = null;
  ...
  Future<InlineResponse20038> destiny2GetCharacter(int characterId, int destinyMembershipId, int membershipType, { List<DestinyDestinyComponentType> components }) async {
    Object postBody = null;
  ...
  Future<InlineResponse20039> destiny2GetClanWeeklyRewardState(int groupId) async {
    Object postBody = null;
  ...
  Future<InlineResponse20034> destiny2GetDestinyEntityDefinition(String entityType, int hashIdentifier) async {
    Object postBody = null;
  ...
  Future<InlineResponse20033> destiny2GetDestinyManifest() async {
    Object postBody = null;
  ...
  Future<InlineResponse20040> destiny2GetItem(int destinyMembershipId, int itemInstanceId, int membershipType, { List<DestinyDestinyComponentType> components }) async {
    Object postBody = null;
  ...
  Future<InlineResponse20036> destiny2GetLinkedProfiles(int membershipId, int membershipType) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/Destiny2/{membershipType}/Profile/{membershipId}/LinkedProfiles/".replaceAll("{format}","json").replaceAll("{" + "membershipId" + "}", membershipId.toString()).replaceAll("{" + "membershipType" + "}", membershipType.toString());
  ...
  Future<InlineResponse20037> destiny2GetProfile(int destinyMembershipId, int membershipType, { List<DestinyDestinyComponentType> components }) async {
    Object postBody = null;
  ...
  Future<InlineResponse20042> destiny2GetVendor(int characterId, int destinyMembershipId, int membershipType, int vendorHash, { List<DestinyDestinyComponentType> components }) async {
    Object postBody = null;
  ...
  Future<InlineResponse20041> destiny2GetVendors(int characterId, int destinyMembershipId, int membershipType, { List<DestinyDestinyComponentType> components }) async {
    Object postBody = null;
  ...
  Future<InlineResponse20019> destiny2PullFromPostmaster() async {
    Object postBody = null;
  ...
  Future<InlineResponse20019> destiny2ReportOffensivePostGameCarnageReportPlayer(int activityId) async {
    Object postBody = null;
  ...
  Future<InlineResponse20035> destiny2SearchDestinyPlayer(String displayName, int membershipType) async {
    Object postBody = null;
  ...
  Future<InlineResponse20019> destiny2SetItemLockState() async {
    Object postBody = null;
  ...
  Future<InlineResponse20019> destiny2TransferItem() async {
    Object postBody = null;
