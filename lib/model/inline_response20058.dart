...
class InlineResponse20058 {
  ...
  @override
  String toString()  {
    return 'InlineResponse20058[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, ]';
  }
}
