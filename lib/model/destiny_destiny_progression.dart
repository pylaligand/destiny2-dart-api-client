...
/* The total amount of progression (i.e. \"Experience\") needed in order to reach the next level. */
  ...
  @override
  String toString()  {
    return 'DestinyDestinyProgression[progressionHash=$progressionHash, dailyProgress=$dailyProgress, dailyLimit=$dailyLimit, weeklyProgress=$weeklyProgress, weeklyLimit=$weeklyLimit, currentProgress=$currentProgress, level=$level, levelCap=$levelCap, stepIndex=$stepIndex, progressToNextLevel=$progressToNextLevel, nextLevelAt=$nextLevelAt, ]';
  }
}
