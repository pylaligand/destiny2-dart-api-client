...
/* If a plug is not enabled, this will be populated with indexes into the plug item definition's plug.enabledRules property, so that you can show the reasons why it is not enabled.  This list will be empty if the plug is enabled. */
  ...
  @override
  String toString()  {
    return 'DestinySocketsDestinyItemPlug[plugItemHash=$plugItemHash, plugObjectives=$plugObjectives, canInsert=$canInsert, enabled=$enabled, insertFailIndexes=$insertFailIndexes, enableFailIndexes=$enableFailIndexes, ]';
  }
}
