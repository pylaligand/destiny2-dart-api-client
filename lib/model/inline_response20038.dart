...
class InlineResponse20038 {
  ...
  @override
  String toString()  {
    return 'InlineResponse20038[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, detailedErrorTrace=$detailedErrorTrace, ]';
  }
}
