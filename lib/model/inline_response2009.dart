...
class InlineResponse2009 {
  ...
  @override
  String toString()  {
    return 'InlineResponse2009[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, ]';
  }
}
