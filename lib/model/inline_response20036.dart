...
class InlineResponse20036 {
  ...
  @override
  String toString()  {
    return 'InlineResponse20036[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, ]';
  }
}
