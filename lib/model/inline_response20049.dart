...
class InlineResponse20049 {
  ...
  @override
  String toString()  {
    return 'InlineResponse20049[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, ]';
  }
}
