...
class InlineResponse2002 {
  ...
  @override
  String toString()  {
    return 'InlineResponse2002[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, detailedErrorTrace=$detailedErrorTrace, ]';
  }
}
