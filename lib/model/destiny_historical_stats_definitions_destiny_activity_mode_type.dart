...
class DestinyHistoricalStatsDefinitionsDestinyActivityModeType {
  ...
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType crimsonDoubles = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(15);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  ...
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType allMayhem = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(25);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  ...
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesAll = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(32);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  ...
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType trialsCountdown = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(41);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType trialsSurvival = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(42);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType ironBannerControl = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(43);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType ironBannerClash = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(44);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType ironBannerSupremacy = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(45);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType scoredNightfall = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(46);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType scoredHeroicNightfall = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(47);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType rumble = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(48);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType allDoubles = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(49);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType doubles = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(50);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesClash = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(51);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesControl = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(52);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesSupremacy = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(53);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesCountdown = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(54);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesSurvival = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(55);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
  static const DestinyHistoricalStatsDefinitionsDestinyActivityModeType privateMatchesMayhem = const DestinyHistoricalStatsDefinitionsDestinyActivityModeType._internal(56);
  /// For historical reasons, this list will have both D1 and D2-relevant Activity Modes in it. Please don't take this to mean that some D1-only feature is coming back!
...
class DestinyHistoricalStatsDefinitionsDestinyActivityModeTypeTypeTransformer extends TypeTransformer<DestinyHistoricalStatsDefinitionsDestinyActivityModeType> {
  ...
  DestinyHistoricalStatsDefinitionsDestinyActivityModeType decode(dynamic data) {
    switch (data) {
      ...
      case 15: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.crimsonDoubles;
      ...
      case 25: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.allMayhem;
      ...
      case 32: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.privateMatchesAll;
      ...
      case 41: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.trialsCountdown;
      case 42: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.trialsSurvival;
      case 43: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.ironBannerControl;
      case 44: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.ironBannerClash;
      case 45: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.ironBannerSupremacy;
      case 46: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.scoredNightfall;
      case 47: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.scoredHeroicNightfall;
      case 48: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.rumble;
      case 49: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.allDoubles;
      case 50: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.doubles;
      case 51: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.privateMatchesClash;
      case 52: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.privateMatchesControl;
      case 53: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.privateMatchesSupremacy;
      case 54: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.privateMatchesCountdown;
      case 55: return DestinyHistoricalStatsDefinitionsDestinyActivityModeType.privateMatchesSurvival;
