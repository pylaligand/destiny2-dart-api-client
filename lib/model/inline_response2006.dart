...
class InlineResponse2006 {
  ...
  @override
  String toString()  {
    return 'InlineResponse2006[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, ]';
  }
}
