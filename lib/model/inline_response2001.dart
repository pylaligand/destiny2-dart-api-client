...
class InlineResponse2001 {
  ...
  @override
  String toString()  {
    return 'InlineResponse2001[response=$response, errorCode=$errorCode, throttleSeconds=$throttleSeconds, errorStatus=$errorStatus, message=$message, messageData=$messageData, ]';
  }
}
