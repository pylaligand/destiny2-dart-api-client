...
**scope** | [**Object**](Object.md) | Where the bucket is found. 0 &#x3D; Character, 1 &#x3D; Account | [optional] [default to null]
**category** | [**Object**](Object.md) | An enum value for what items can be found in the bucket. See the BucketCategory enum for more details. | [optional] [default to null]
