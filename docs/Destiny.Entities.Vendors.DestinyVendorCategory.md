# destiny2_api.model.DestinyEntitiesVendorsDestinyVendorCategory
...
------------ | ------------- | ------------- | -------------
**categoryIndex** | **int** | An index into the DestinyVendorDefinition.categories property, so you can grab the display data for this category. | [optional] [default to null]
