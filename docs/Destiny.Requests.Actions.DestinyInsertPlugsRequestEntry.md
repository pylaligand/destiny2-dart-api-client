# destiny2_api.model.DestinyRequestsActionsDestinyInsertPlugsRequestEntry
...
------------ | ------------- | ------------- | -------------
**socketIndex** | **int** | The index into the socket array, which identifies the specific socket being operated on. We also need to know the socketArrayType in order to uniquely identify the socket.  Don&#39;t point to or try to insert a plug into an infusion socket. It won&#39;t work. | [optional] [default to null]
