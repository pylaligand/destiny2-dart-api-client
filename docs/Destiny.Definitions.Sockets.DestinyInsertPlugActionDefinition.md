# destiny2_api.model.DestinyDefinitionsSocketsDestinyInsertPlugActionDefinition
...
------------ | ------------- | ------------- | -------------
**actionExecuteSeconds** | **int** | How long it takes for the Plugging of the item to be completed once it is initiated, if you care. | [optional] [default to null]
