...
------------ | ------------- | ------------- | -------------
**genderType** | [**Object**](Object.md) | This is a quick reference enumeration for all of the currently defined Genders. We use the enumeration for quicker lookups in related data, like DestinyClassDefinition.genderedClassNames. | [optional] [default to null]
