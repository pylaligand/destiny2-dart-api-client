# destiny2_api.model.DestinyDefinitionsDestinyMaterialRequirementSetDefinition
...
------------ | ------------- | ------------- | -------------
**materials** | [**List&lt;DestinyDefinitionsDestinyMaterialRequirement&gt;**](DestinyDefinitionsDestinyMaterialRequirement.md) | The list of all materials that are required. | [optional] [default to []]
