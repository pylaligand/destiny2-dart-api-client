# destiny2_api.model.DestinyDefinitionsDestinyNodeStepDefinition
...
------------ | ------------- | ------------- | -------------
**displayProperties** | [**DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition**](DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition.md) | These are the display properties actually used to render the Talent Node. The currently active step&#39;s displayProperties are shown. | [optional] [default to null]
...
**damageType** | [**DestinyDamageType**](DestinyDamageType.md) | An enum representing a damage type granted by activating this step, if any. | [optional] [default to null]
