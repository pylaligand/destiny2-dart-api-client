# destiny2_api.model.DestinyDefinitionsDestinyTalentGridDefinition
...
------------ | ------------- | ------------- | -------------
**maxGridLevel** | **int** | The maximum possible level of the Talent Grid: at this level, any nodes are allowed to be activated. | [optional] [default to null]
