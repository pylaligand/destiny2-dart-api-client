# destiny2_api.model.DestinyDefinitionsDestinyVendorGroupDefinition
...
------------ | ------------- | ------------- | -------------
**order** | **int** | The recommended order in which to render the groups, Ascending order. | [optional] [default to null]
**categoryName** | **String** | For now, a group just has a name. | [optional] [default to null]
